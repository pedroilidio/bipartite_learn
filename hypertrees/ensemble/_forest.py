...
class BiclusteringRandomForestRegressor(ForestRegressorND):
    """
    A random forest regressor.
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            base_estimator=BiclusteringTreeRegressor(),
            n_estimators=n_estimators,
            estimator_params=(
                "criterion",
                "max_depth",
...
class BiclusteringExtraTreesRegressor(ForestRegressorND):
    """
    An extra-trees regressor.
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            base_estimator=BiclusteringExtraTreeRegressor(),
            n_estimators=n_estimators,
            estimator_params=(
                "criterion",
                "max_depth",
